...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-23 21:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/0c8bd7bb-cce8-4b2a-b5a8-a33bef3cb24e.git
$ cd 0c8bd7bb-cce8-4b2a-b5a8-a33bef3cb24e
```
